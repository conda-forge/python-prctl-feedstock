...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/python-prctl-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-prctl-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-prctl
# for installing globally
pixi global install python-prctl
```
...
It is possible to list all of the versions of `python-prctl` available on your platform:
...
```
pixi search python-prctl --channel conda-forge
```
